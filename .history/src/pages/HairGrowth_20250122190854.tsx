  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[45%_55%] min-h-[calc(100vh-80px)] bg-[#F8F5F2]">
        ...
        <div className="relative overflow-hidden hidden lg:block bg-white h-[calc(100vh-80px)] after:content-[''] after:absolute after:inset-x-0 after:top-0 after:h-32 after:bg-gradient-to-b after:from-white after:to-transparent after:z-10 before:content-[''] before:absolute before:inset-x-0 before:bottom-0 before:h-32 before:bg-gradient-to-t before:from-white before:to-transparent before:z-10">

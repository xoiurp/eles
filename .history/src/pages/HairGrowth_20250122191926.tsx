            ...
            <div className="grid grid-cols-2 gap-6 h-full">
              ...
              <div className="relative overflow-hidden">
                <div className="h-[200%] animate-scroll-down transform-gpu">
                  ...
                  <div className="space-y-4">
                    <img src="https://hxvvkrnxgdfledopeatb.supabase.co/storage/v1/object/public/bolt/hair1.webp" alt="Hair Product 1" className="w-full aspect-[4/5] object-cover rounded-2xl shadow-lg hover:scale-[1.02] transition-transform" />

  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[45%_55%] min-h-[calc(100vh-80px)] bg-[#F8F5F2]">
        ...
        <div className="relative overflow-hidden hidden lg:block bg-white h-[calc(100vh-80px)] after:content-[''] after:absolute after:inset-x-0 after:top-0 after:h-40 after:bg-gradient-to-b after:from-white after:to-transparent after:z-10 before:content-[''] before:absolute before:inset-x-0 before:bottom-0 before:h-40 before:bg-gradient-to-t before:from-white before:to-transparent before:z-10">
          {/* Gradients */}
          <div className="absolute inset-0 py-24 px-6">
            <div className="grid grid-cols-2 gap-6 h-full">
          {/* Scroll Columns Container */}
          <div className="absolute inset-0 py-20 px-4 grid grid-cols-2 gap-4">
            ...
            <div className="relative overflow-hidden">
              <div className="h-[200%] animate-scroll-down transform-gpu">
                ...
                <div className="space-y-4">
                  ...
                  />
                  <img 
                    src="https://hxvvkrnxgdfledopeatb.supabase.co/storage/v1/object/public/bolt/hair2.webp"
                    alt="Hair Product 2"
                    className="w-full aspect-[3/2] object-cover rounded-2xl shadow-lg"
                  />
                  <img 
                    src="https://hxvvkrnxgdfledopeatb.supabase.co/storage/v1/object/public/bolt/hair3.webp"
                    alt="Hair Product 3"
                    className="w-full aspect-[3/2] object-cover rounded-2xl shadow-lg"
                  />
                </div>
                ...
                <div className="space-y-4">
                  <img src="https://hxvvkrnxgdfledopeatb.supabase.co/storage/v1/object/public/bolt/hair1.webp" alt="Hair Product 1" className="w-full aspect-[3/2] object-cover rounded-2xl shadow-lg" />
                  <img src="https://hxvvkrnxgdfledopeatb.supabase.co/storage/v1/object/public/bolt/hair2.webp" alt="Hair Product 2" className="w-full aspect-[3/2] object-cover rounded-2xl shadow-lg" />
                  <img src="https://hxvvkrnxgdfledopeatb.supabase.co/storage/v1/object/public/bolt/hair3.webp" alt="Hair Product 3" className="w-full aspect-[3/2] object-cover rounded-2xl shadow-lg" />
                </div>
              </div>
            </div>
            ...
            <div className="relative overflow-hidden">
              <div className="h-[200%] animate-scroll-up transform-gpu">
                ...
                <div className="space-y-4">
                  <img 
                    src="https://hxvvkrnxgdfledopeatb.supabase.co/storage/v1/object/public/bolt/hair4.webp"
                    alt="Hair Product 4"
                    className="w-full aspect-[3/2] object-cover rounded-2xl shadow-lg"
                  />
                  <img 
                    src="https://hxvvkrnxgdfledopeatb.supabase.co/storage/v1/object/public/bolt/hair5.webp"
                    alt="Hair Product 5"
                    className="w-full aspect-[3/2] object-cover rounded-2xl shadow-lg"
                  />
                  <img 
                ...
                {/* Duplicate set for seamless loop */}
                <div className="space-y-4">
                  <img src="https://hxvvkrnxgdfledopeatb.supabase.co/storage/v1/object/public/bolt/hair4.webp" alt="Hair Product 4" className="w-full aspect-[3/2] object-cover rounded-2xl shadow-lg" />
                  <img src="https://hxvvkrnxgdfledopeatb.supabase.co/storage/v1/object/public/bolt/hair5.webp" alt="Hair Product 5" className="w-full aspect-[3/2] object-cover rounded-2xl shadow-lg" />
                  <img src="https://hxvvkrnxgdfledopeatb.supabase.co/storage/v1/object/public/bolt/hair6.webp" alt="Hair Product 6" className="w-full aspect-[3/2] object-cover rounded-2xl shadow-lg" />
                </div>
              </div>
            </div>
          </div>

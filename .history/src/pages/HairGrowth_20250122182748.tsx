...
function HairGrowth() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen bg-[#F5F0EA]">
        {/* Left Column - Content */}
        ...
        <div className="relative h-[calc(100vh-80px)] overflow-hidden hidden lg:block">
          <div className="absolute inset-0">
            <div className="h-[200%] animate-scroll-vertical">
              ...
              <div className="grid grid-cols-2 gap-4 p-4">
                <img src="https://hxvvkrnxgdfledopeatb.supabase.co/storage/v1/object/public/bolt/hair1.webp" alt="Hair Product 1" className="w-full h-80 object-cover rounded-2xl" />
                <img src="https://hxvvkrnxgdfledopeatb.supabase.co/storage/v1/object/public/bolt/hair2.webp" alt="Hair Product 2" className="w-full h-80 object-cover rounded-2xl" />
                <img src="https://hxvvkrnxgdfledopeatb.supabase.co/storage/v1/object/public/bolt/hair3.webp" alt="Hair Product 3" className="w-full h-80 object-cover rounded-2xl" />
                <img src="https://hxvvkrnxgdfledopeatb.supabase.co/storage/v1/object/public/bolt/hair4.webp" alt="Hair Product 4" className="w-full h-80 object-cover rounded-2xl" />
              </div>
            </div>
          </div>
        </div>

...
function HairGrowth() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[45%_55%] min-h-screen bg-[#F5F0EA]">
        {/* Left Column - Content */}
        <div className="flex flex-col justify-center px-8 lg:px-20 py-12">
          ...
          <div className="space-y-6 mb-12">
            <div className="flex items-start gap-3">
              ...
              <p className="text-lg text-gray-700">Recupere seus cabelos em 3-6 meses*</p>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle2 className="w-6 h-6 text-rose-500 flex-shrink-0 mt-1" />
              <p className="text-lg text-gray-700">Ingredientes aprovados por médicos</p>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle2 className="w-6 h-6 text-rose-500" />
              <p className="text-lg text-gray-700">100% online, com suporte ilimitado</p>
            </div>
          </div>
        ...
        <div className="relative overflow-hidden hidden lg:block bg-white">
          <div className="absolute inset-0 py-8">
            <div className="h-[200%] animate-scroll-vertical transform-gpu">
              ...
              <div className="grid grid-cols-1 gap-6 px-6">
                <img src="https://hxvvkrnxgdfledopeatb.supabase.co/storage/v1/object/public/bolt/hair1.webp" alt="Hair Product 1" className="w-full aspect-[4/3] object-cover rounded-2xl" />
                <img src="https://hxvvkrnxgdfledopeatb.supabase.co/storage/v1/object/public/bolt/hair2.webp" alt="Hair Product 2" className="w-full aspect-[4/3] object-cover rounded-2xl" />
                <img src="https://hxvvkrnxgdfledopeatb.supabase.co/storage/v1/object/public/bolt/hair3.webp" alt="Hair Product 3" className="w-full aspect-[4/3] object-cover rounded-2xl" />
                <img src="https://hxvvkrnxgdfledopeatb.supabase.co/storage/v1/object/public/bolt/hair4.webp" alt="Hair Product 4" className="w-full aspect-[4/3] object-cover rounded-2xl" />
              </div>
            </div>
          </div>
        </div>

    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[45%_55%] min-h-[calc(100vh-80px)] bg-[#F8F5F2]">
        ...
        <div className="flex flex-col justify-center px-8 lg:px-24 py-20">
          ...
          <button className="bg-black text-white px-8 py-4 rounded-full text-lg font-medium hover:bg-rose-500 transition-all duration-300 w-fit">
        ...
        <div className="relative overflow-hidden hidden lg:block bg-white h-[calc(100vh-80px)] after:content-[''] after:absolute after:inset-x-0 after:top-0 after:h-20 after:bg-gradient-to-b after:from-white after:to-transparent after:z-10 before:content-[''] before:absolute before:inset-x-0 before:bottom-0 before:h-20 before:bg-gradient-to-t before:from-white before:to-transparent before:z-10">
          <div className="absolute inset-0 py-20">
            <div className="h-[200%] animate-scroll-vertical transform-gpu">
              {/* First set of images - Original */}
              <div className="grid grid-cols-1 gap-6 px-6">
                <img 
                  src="https://hxvvkrnxgdfledopeatb.supabase.co/storage/v1/object/public/bolt/hair1.webp"
                  alt="Hair Product 1"
